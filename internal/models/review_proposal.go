...
// ReviewProposal represents db_review_proposal table
...
// TableName specifies the table name for ReviewProposal model
func (ReviewProposal) TableName() string {
	return "db_review_proposal"
}
